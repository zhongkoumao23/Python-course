...
number1 = 6
number2 = 5
resulting_product = product_two_numbers(number1, number2)
print("The product of {} which are working hours and {} which is wage rate is {}".format(number1, number2,
                                                                                         resulting_product))
...
number3 = 4
number4 = 3
resulting_sum = sum_two_numbers(number3, number4)
print(
    "The sum of {} which is depreciation/unit/machine and {} which is raw material/unit is {}".format(number3, number4,
                                                                                                      resulting_sum))
...
def sum_cost(resulting_sum, resulting_product):
    result4 = resulting_sum + resulting_product
    return result4


final_cost = sum_cost(resulting_sum, resulting_product)
print("The total cost per day is {} + {} which is the sum of dead part and labour part".format(resulting_product, resulting_sum, sum_cost))
